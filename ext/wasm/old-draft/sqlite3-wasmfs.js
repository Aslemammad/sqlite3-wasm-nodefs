...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 128450560;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
var wasmBinaryFile;
  wasmBinaryFile = 'sqlite3-wasmfs.wasm';
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('sqlite3-wasmfs.worker.js');
