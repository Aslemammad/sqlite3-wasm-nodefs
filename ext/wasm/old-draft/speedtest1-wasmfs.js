...
["_wasm_main","_sqlite3_aggregate_context","_sqlite3_bind_blob","_sqlite3_bind_double","_sqlite3_bind_int","_sqlite3_bind_int64","_sqlite3_bind_null","_sqlite3_bind_parameter_count","_sqlite3_bind_parameter_index","_sqlite3_bind_text","_sqlite3_changes","_sqlite3_changes64","_sqlite3_clear_bindings","_sqlite3_close_v2","_sqlite3_column_blob","_sqlite3_column_bytes","_sqlite3_column_count","_sqlite3_column_double","_sqlite3_column_int","_sqlite3_column_int64","_sqlite3_column_name","_sqlite3_column_text","_sqlite3_column_type","_sqlite3_compileoption_get","_sqlite3_compileoption_used","_sqlite3_create_function","_sqlite3_create_function_v2","_sqlite3_create_window_function","_sqlite3_data_count","_sqlite3_db_filename","_sqlite3_db_handle","_sqlite3_db_name","_sqlite3_deserialize","_sqlite3_errmsg","_sqlite3_error_offset","_sqlite3_errstr","_sqlite3_exec","_sqlite3_expanded_sql","_sqlite3_extended_errcode","_sqlite3_extended_result_codes","_sqlite3_file_control","_sqlite3_finalize","_sqlite3_free","_sqlite3_initialize","_sqlite3_libversion","_sqlite3_libversion_number","_sqlite3_malloc","_sqlite3_malloc64","_sqlite3_msize","_sqlite3_open","_sqlite3_open_v2","_sqlite3_prepare_v2","_sqlite3_prepare_v3","_sqlite3_randomness","_sqlite3_realloc","_sqlite3_realloc64","_sqlite3_reset","_sqlite3_result_blob","_sqlite3_result_double","_sqlite3_result_error","_sqlite3_result_error_code","_sqlite3_result_error_nomem","_sqlite3_result_error_toobig","_sqlite3_result_int","_sqlite3_result_int64","_sqlite3_result_null","_sqlite3_result_text","_sqlite3_serialize","_sqlite3_shutdown","_sqlite3_sourceid","_sqlite3_sql","_sqlite3_step","_sqlite3_strglob","_sqlite3_strlike","_sqlite3_total_changes","_sqlite3_total_changes64","_sqlite3_trace_v2","_sqlite3_uri_boolean","_sqlite3_uri_int64","_sqlite3_uri_key","_sqlite3_uri_parameter","_sqlite3_user_data","_sqlite3_value_blob","_sqlite3_value_bytes","_sqlite3_value_double","_sqlite3_value_int","_sqlite3_value_int64","_sqlite3_value_text","_sqlite3_value_type","_sqlite3_vfs_find","_sqlite3_vfs_register","_sqlite3_vfs_unregister","_malloc","_free","__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_tls_init","_pthread_self","executeNotifiedProxyingQueue","establishStackSpace","invokeEntryPoint","PThread","_fflush","_sqlite3_wasm_pstack_ptr","_sqlite3_wasm_pstack_restore","_sqlite3_wasm_pstack_alloc","_sqlite3_wasm_pstack_remaining","_sqlite3_wasm_pstack_quota","_sqlite3_wasm_db_error","_sqlite3_wasm_test_struct","_sqlite3_wasm_enum_json","_sqlite3_wasm_vfs_unlink","_sqlite3_wasm_db_vfs","_sqlite3_wasm_db_reset","_sqlite3_wasm_db_export_chunked","_sqlite3_wasm_db_serialize","_sqlite3_wasm_vfs_create_file","_sqlite3_wasm_kvvfsMakeKeyOnPstack","_sqlite3_wasm_kvvfs_methods","_sqlite3_wasm_init_wasmfs","_sqlite3_wasm_test_intptr","_sqlite3_wasm_test_int64_max","_sqlite3_wasm_test_int64_min","_sqlite3_wasm_test_int64_times2","_sqlite3_wasm_test_int64_minmax","_sqlite3_wasm_test_int64ptr","_sqlite3_wasm_test_stack_overflow","_sqlite3_wasm_test_str_hello","__wasmfs_fetch_get_file_path","__wasmfs_node_record_dirent","__wasmfs_opfs_record_entry","__emscripten_proxy_execute_task_queue","onRuntimeInitialized"].forEach((prop) => {
...
/* END FILE: api/pre-js.js, noting that the build process may add a
   ...
   one. */
Module[xNameOfInstantiateWasm].uri = 'speedtest1-wasmfs.wasm';
...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 13107200;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
var wasmBinaryFile;
  wasmBinaryFile = 'speedtest1-wasmfs.wasm';
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('speedtest1-wasmfs.worker.js');
  ...
  function _tzset_impl(timezone, daylight, tzname) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(4, 1, timezone, daylight, tzname);
  ...
  function wasmfsOPFSFree(ids, id) {
      assert(ids.allocated[id] !== undefined);
      delete ids.allocated[id];
      ids.free.push(id);
    }
  
  var wasmfsOPFSAccessHandles = {allocated:[],free:[],get:function(i) {
  ...
  var wasmfsOPFSBlobs = {allocated:[],free:[],get:function(i) {
        assert(this.allocated[i] !== undefined);
        return this.allocated[i];
      }};
  ...
  var wasmfsOPFSDirectoryHandles = {allocated:[],free:[],get:function(i) {
        assert(this.allocated[i] !== undefined);
        return this.allocated[i];
      }};
  ...
  var wasmfsOPFSFileHandles = {allocated:[],free:[],get:function(i) {
        assert(this.allocated[i] !== undefined);
        return this.allocated[i];
      }};
  ...
  function wasmfsOPFSAllocate(ids, handle) {
      let id;
  ...
  async function __wasmfs_opfs_get_size_access(ctx, accessID, sizePtr) {
      ...
      (tempI64 = [size>>>0,(tempDouble=size,(+(Math.abs(tempDouble))) >= 1.0 ? (tempDouble > 0.0 ? ((Math.min((+(Math.floor((tempDouble)/4294967296.0))), 4294967295.0))|0)>>>0 : (~~((+(Math.ceil((tempDouble - +(((~~(tempDouble)))>>>0))/4294967296.0)))))>>>0) : 0)],HEAP32[((sizePtr)>>2)] = tempI64[0],HEAP32[(((sizePtr)+(4))>>2)] = tempI64[1]);
      _emscripten_proxy_finish(ctx);
    }
  ...
  async function __wasmfs_opfs_move(ctx, fileID, newDirID, namePtr, errPtr) {
      let name = UTF8ToString(namePtr);
      let fileHandle = wasmfsOPFSFileHandles.get(fileID);
  ...
  async function __wasmfs_opfs_set_size_access(ctx, accessID,
                                                 /** @type {!BigInt} */ size,
                                                 errPtr) {
      size = Number(size);;
      let accessHandle = wasmfsOPFSAccessHandles.get(accessID);
  ...
  async function __wasmfs_opfs_set_size_file(ctx, fileID,
                                               /** @type {!BigInt} */ size,
                                               errPtr) {
      size = Number(size);;
      let fileHandle = wasmfsOPFSFileHandles.get(fileID);
...
var proxiedFunctionTable = [null,_proc_exit,exitOnMainThread,pthreadCreateProxied,_tzset_impl,_environ_get,_environ_sizes_get];
...
var asmLibraryArg = {
  ...
  "_wasmfs_opfs_move": __wasmfs_opfs_move,
...
/* BEGIN FILE: api/sqlite3-api-nodefs.js */
  ...
  const thePromise = new Promise(function(promiseResolve, promiseReject_){
    ...
    */
    const opRun = (op,...args)=>{
      ...
      console.log('opRun here')
      Atomics.wait(state.sabOPView, state.opIds.rc, -1)
      console.log('opRun there')
...
/* END FILE: api/sqlite3-api-nodefs.js */
