...
/* END FILE: api/pre-js.js, noting that the build process may add a
   ...
   one. */
Module[xNameOfInstantiateWasm].uri = 'speedtest1.wasm';
...
var wasmBinaryFile;
  wasmBinaryFile = 'speedtest1.wasm';
